...
namespace Allo.ua.Pages
{
    public class SearchResultPage: BasePage
    {
        ...
        public PageComponent SideBar => new(driver, "//div[contains(@class, 'navigation')]");
        public MainPageComponent MainContainer => new(driver, "//div[contains(@class, 'container products')]");
