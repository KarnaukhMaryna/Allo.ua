...
namespace Allo.ua.Pages
{
    public class ProductPage : BasePage
    {
        ...
        public MainDataBlock MainBlock => new(driver, "//main[@data-block='main']");
        public PopupComponent PopupForAddToCart => new(driver, "//div[contains(@class, 'md cart-popup')]");
        public DescriptionBlock Description => new(driver, "//div[contains(@class, 'description-suites')]");
        ...
        public bool PopupIsDisplayed() => driver.FindElement(By.XPath("//div[contains(@class, 'md cart-popup')]")).Displayed;
